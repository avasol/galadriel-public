...
def search_memories(
    ...
    for stored_drawer_id, doc, meta, dist in zip(
        ...
        # ── LIVING-MEMORY EXTENSION (galadriel, 2026-06-15; re-applied 2026-08-26 for 3.8.0) ──
        # Skip drawers whose lifecycle has moved past `active`, unless the
        # caller explicitly asks for them. Drawers with no lifecycle_status
        # (pre-extension or unstamped) are treated as active — back-compatible.
        if not include_stale:
            _ls = meta.get("lifecycle_status", "active")
